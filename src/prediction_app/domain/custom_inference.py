...
def inference_test():
    ...
    start = perf_counter()
    data = np.load('/Users/foryourselfand/Documents/gazprom_test_task/gazprom_test_task/ds/data.npz')
    ...
    start = perf_counter()
    model_wb = np.load('/Users/foryourselfand/Documents/gazprom_test_task/gazprom_test_task/ds/SFDDD_model.npz')
